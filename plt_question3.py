...
values = [8177.04, 161800.0, 153622.96]  # Unit: CNY
...
requirements = np.array([[240, 160, 120, 80], [240, 160, 120, 80]])  # 需求值矩阵
actuals = np.array([[240, 160, 120, 80], [240, 160, 120, 80]])  # 实际值矩阵
